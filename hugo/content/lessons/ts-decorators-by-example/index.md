...
**Real World Use Case:** When a class is decorated you have to be careful with inheritance because its descendants will not inherit the decorators. Let's freeze the class to prevent inheritance completely. 
